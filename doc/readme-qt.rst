SumCoin-qt: Qt5 GUI for SumCoin
===============================
...
the current build system. SumCoin migrated to automake, autotool and friends,
...
The static binary version of SumCoin is linked against libdb 5.0 (see also `this Debian issue`_).
